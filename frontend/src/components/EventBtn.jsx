...
function EventBtn({ label }) {
  ...
  const handleMouseEnter = () => {
    ...
    const arrowTargetX = -(buttonWidth * 0.7) // Move 40% of button width to the left
  ...
  return (
    <div className="flex-shrink-0 ml-4">
      <button
        ref={buttonRef}
        className="flex items-center gap-2 bg-white border-2 border-black rounded-full px-8 py-2 hover:bg-gray-50 transition-colors group overflow-hidden relative"
