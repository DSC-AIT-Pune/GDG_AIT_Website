...
function Collaborate() {
  return (
    <div className='flex mx-auto w-[95vw] flex-col lg:flex-row justify-center gap-y-8 lg:justify-between lg:px-16 md:py-16   lg:py-20 items-center rounded-xl bg-primarybg'>
        <div>
